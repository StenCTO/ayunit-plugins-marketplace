...
|---|---|---|
| `account-transaction` | 0.12.1 | `ubs-miami`, `transaction-workday-audit`, `pending-revalidate`, `pending-position-repair`, `duplicate-trade-reconcile`, `assetrelated-fix`, `compromissada-fix`, `position-quantity-adjustment` |
...
| `routines` | 0.5.0 | `new-asset-onboarding`, `daily-btg-onshore-routine`, `daily-btg-offshore-routine` |
